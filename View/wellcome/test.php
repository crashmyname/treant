...
<head>
  ...
  <link rel="stylesheet" href="<?= asset('stisla-1-2.2.0/dist/assets/modules/owlcarousel2/dist/assets/owl.carousel.min.css')?>">
  <link rel="stylesheet" href="<?= asset('stisla-1-2.2.0/dist/assets/modules/owlcarousel2/dist/assets/owl.theme.default.min.css')?>">
        ...
        <form class="form-inline mr-auto">
          ...
          <div class="search-element">
            ...
            <div class="search-result">
              ...
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-3-50.png')?>" alt="product">
                  oPhone S9 Limited Edition
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-2-50.png')?>" alt="product">
                  Drone X2 New Gen-7
                </a>
              </div>
              <div class="search-item">
                <a href="#">
                  <img class="mr-3 rounded" width="30" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-1-50.png')?>" alt="product">
                  Headphone Blitz
                </a>
              </div>
              <div class="search-header">
              ...
              <div class="dropdown-list-content dropdown-list-message">
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/avatar/avatar-1.png')?>" class="rounded-circle">
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/avatar/avatar-2.png')?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Dedik Sugiharto</b>
                ...
                <a href="#" class="dropdown-item dropdown-item-unread">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/avatar/avatar-3.png')?>" class="rounded-circle">
                    <div class="is-online"></div>
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/avatar/avatar-4.png')?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                ...
                <a href="#" class="dropdown-item">
                  <div class="dropdown-item-avatar">
                    <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/avatar/avatar-5.png')?>" class="rounded-circle">
                  </div>
                  <div class="dropdown-item-desc">
                    <b>Alfa Zulkarnain</b>
              ...
              <div class="card gradient-bottom">
                ...
                <div class="card-body" id="top-5-scroll">
                  <ul class="list-unstyled list-unstyled-border">
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-3-50.png')?>" alt="product">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-4-50.png')?>" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-1-50.png')?>" alt="product">
                      <div class="media-body">
                    ...
                    <li class="media">
                      <img class="mr-3 rounded" width="55" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-5-50.png')?>" alt="product">
                      <div class="media-body">
                  ...
                  <div class="owl-carousel owl-theme" id="products-carousel">
                    <div>
                      <div class="product-item pb-3">
                        <div class="product-image">
                          <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-4-50.png')?>" class="img-fluid">
                        </div>
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-3-50.png')?>" class="img-fluid">
                        </div>
                        <div class="product-details">
                    ...
                    <div>
                      <div class="product-item">
                        <div class="product-image">
                          <img alt="image" src="<?= asset('stisla-1-2.2.0/dist/assets/img/products/product-1-50.png')?>" class="img-fluid">
                        </div>
                        <div class="product-details">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= asset('stisla-1-2.2.0/dist/assets/modules/flag-icon-css/flags/4x3/id.svg')?>" alt="image" width="40">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= asset('stisla-1-2.2.0/dist/assets/modules/flag-icon-css/flags/4x3/my.svg')?>" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= asset('stisla-1-2.2.0/dist/assets/modules/flag-icon-css/flags/4x3/us.svg')?>" alt="image" width="40">
                          <div class="media-body ml-3">
                    ...
                    <div class="col-sm-6 mt-sm-0 mt-4">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= asset('stisla-1-2.2.0/dist/assets/modules/flag-icon-css/flags/4x3/ps.svg')?>" alt="image" width="40">
                          <div class="media-body ml-3">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?= asset('stisla-1-2.2.0/dist/assets/modules/flag-icon-css/flags/4x3/de.svg')?>" alt="image" width="40">
                          <div class="media-body ml-3">
