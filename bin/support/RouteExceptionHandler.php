...
class RouteExceptionHandler
{
    public static function handle($exception)
    {
        ...
        if (strpos($exception->getMessage(), 'Class') !== false) {
            ...
            include __DIR__ . '/../../src/View/errors/controller_not_found.php'; // Ganti dengan view error sesuai kebutuhan
            exit();
        }

        // Jika bukan kesalahan controller, gunakan metode lain jika perlu
        http_response_code(500);
        include __DIR__ . '/../../src/View/errors/500.php'; // Ganti dengan view error umum
        exit();
    }
}
